  ...
  <div class="login-box">
    ...
    <div class="card card-outline card-primary">
      ...
      <div class="card-body">
        ...
        @endif
        <p class="login-box-msg">Silahkan Mengisi data dibawah</p>
        ...
        <form action="{{ route("register.proses") }}" method="post">
          ...
          <div class="input-group mb-3">
            <input type="password" name="konfirmasi_password" class="form-control" value="{{ old('konfirmasi_password') }}" placeholder="Konfirmasi Password" required>
            <div class="input-group-append">
              <div class="input-group-text">
                <span class="fas fa-lock"></span>
              </div>
          ...
          <div class="row">
            <div class="col-8">
              <div class="icheck-primary">
                <a href="/"><font color="black">Kembali</font></a>
              </div>
            </div>
            <!-- /.col -->
            <div class="col-4">
